from sqlalchemy import Column, BigInteger, Integer, String, Float, Date, DateTime, ForeignKey, Index
...
class SalesTransaction(Base):
    ...
    upload_job = relationship("UploadJob", back_populates="sales_transactions")
